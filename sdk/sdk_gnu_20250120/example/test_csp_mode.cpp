...
void setPos(int id, int pos, bool isSync)
{
    huint8 data[4];
...
int main()
{
    ...
    if (HARMONIC_SUCCESS != harmonic_setOperateMode(devIndex, id, harmonic_OperateMode_CyclicSyncPosition))
    {
    ...
    if (HARMONIC_SUCCESS != harmonic_setRPDOMapped(devIndex, id, 0, 0, (0x607A << 16) + 0x020))
    {
